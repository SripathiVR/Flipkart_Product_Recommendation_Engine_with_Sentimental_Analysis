...
# Load sentiment data
sentiment_data = pd.read_csv("D:/Guvi/projects/Flipkart/FlipKart_Dataset_with_Sentiment_Analysis.csv")
...
st.markdown("<p style='text-align: center; font-size:14px; color:gray;'>Flipkart Product Recommendation Engine by <b>Sripathi_V_R</b></p>", unsafe_allow_html=True)
